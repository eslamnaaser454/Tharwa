...
export default function ProductPreview() {
  ...
  return (
    <section className="bg-paper py-[110px] max-[760px]:py-20" aria-labelledby="preview-title">
      <div className="mx-auto max-w-[1200px] px-7">
        <Reveal className="mx-auto mb-16 max-w-[760px] text-center">
          ...
          <h2 id="preview-title" className="font-display text-[clamp(34px,4.4vw,56px)] font-medium leading-[1.08] tracking-tight text-ink">
            {t("title")}
          </h2>
